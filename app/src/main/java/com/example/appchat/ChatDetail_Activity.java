...
import com.example.appchat.databinding.ActivityChatDetailBinding;
...
public class ChatDetail_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.backArrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ChatDetail_Activity.this , MainActivity.class);
